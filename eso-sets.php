...
final class EsoSets
{
    ...
    public function esoskill_skillbar_func($atts)
    {
        ...
        foreach ($result as $key => $skill) {
            ...
            if ($key === 'skill_ult') {
                $return .= 'data-html="true" title="' . htmlspecialchars($tooltip) . '"><img class="skill-img" alt="' . $skill['name'] . '" style="margin-left:25px;" src="' . $skill['img'] . '" /></a> ';
            } else {
                $return .= 'data-html="true" title="' . htmlspecialchars($tooltip) . '"><img class="skill-img" alt="' . $skill['name'] . '" src="' . $skill['img'] . '" /></a> ';
            }
        }
    ...
    public function esoskill_skilllist_func($atts)
    {
        ...
        foreach ($result as $skill) {
            ...
            $return .= '" src="' . $skill['img'] . '" alt="' . $skill['name'] . '" /></a> ';
        }
